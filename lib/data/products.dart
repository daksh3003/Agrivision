...
List<Product> products = [
  const Product(
    name: "Farming Tips and Best Practices:",
    description:
  ...
  const Product(
    name: "Fertilizer and Pesticide Guidance:",
    description:
  ...
  const Product(
    name: "Farm Equipment Rentals and Sales:",
    description:
  ...
  const Product(
    name: "Agro-based News and Updates:",
    description:
