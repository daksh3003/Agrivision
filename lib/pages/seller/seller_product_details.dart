...
class SellerProductDetails extends StatefulWidget {
  ...
  @override
  State<SellerProductDetails> createState() => _ProductDetailsPageState();
}

class _ProductDetailsPageState extends State<SellerProductDetails> {
            ...
            child: ListView.separated(
              ...
              itemBuilder: (context, index) {
                return Container(
                  ...
                  decoration: BoxDecoration(
                    image: DecorationImage(
                      image: AssetImage(sellerProducts[index].image),
                      fit: BoxFit.cover,
                    ),
